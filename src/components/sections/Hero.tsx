    ...
    <section className="relative min-h-[80vh] sm:min-h-[60vh] flex items-center justify-center bg-gradient-to-b from-kakao to-white py-16 overflow-hidden">
      ...
      <div className="container max-w-xl md:max-w-5xl relative z-10 mx-auto px-4 text-center">
        ...
        <motion.h1
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="text-4xl md:text-6xl font-black mb-4 text-kakao-text"
        >
          카카오톡채널 개설 및 운영 <br className="hidden sm:block" />
          <span className="bg-white px-2 py-1 rounded-md">무료 대행!</span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-lg md:text-xl mb-6 text-gray-800 max-w-2xl mx-auto"
        >
        ...
        <motion.p
          ...
          className="text-lg md:text-xl mb-8 text-gray-800 font-semibold"
        >
